...
| 用途/比例 | 尺寸 | MP | H3 使用建议 |
|---|---:|---:|---|
| 横屏 16:9（低显存快速档） | `640×352` | 0.23 | 8 GB 显存首选 |
| 横屏 16:9（实验档） | `736×416` | 0.31 | 提升细节和动作遵循度 |
| 横屏 16:9（约 0.4MP） | `864×480` | 0.42 | 质量更好但更慢 |
| 横屏 16:9（高分辨率） | `1280×704` | 0.90 | 接近 720P，8 GB 显存不建议直接生成 |
| 竖屏 9:16（低显存） | `352×640` | 0.23 | 适合短视频竖屏草稿 |
| 竖屏 9:16（中等质量） | `416×736` | 0.31 | 兼顾细节和显存 |
| 竖屏 9:16（约 0.4MP） | `480×864` | 0.42 | 更清晰但耗时更长 |
| 方形 1:1 | `512×512` | 0.26 | 通用尺寸，H3 更占显存 |
